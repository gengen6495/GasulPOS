<?php 
  ...
  if(isset($_POST['add_user'])){
     ...
     $insert_query = mysqli_query($conn, "INSERT INTO `user_data`(username, contact_number, email_address, password, user_type) VALUES('$p_name', '$p_No', '$p_email', '$p_pass', 'customer')") or die('query failed');
...
<div id="header">
   ...
   <div class="sidebar"><center>
        ...
        <li><a href="manager_dashboard.php"><img src="image/dashboard.png" style="width: 30px; display: inline-block; vertical-align: middle;">
                ...
                <li>
                  <div class="dropdown">
                      ...
                      <a class="active" href="user.php">Customer List</a>
                      </div>
                    </div></span></li>
    ...
    </div><button type="button" id="addUserButton" class="button">Add a New Customer</button>
<div class="modal" id="addUserModal">
    ...
    <?php 
        ...
        $sql = "SELECT * FROM `user_data` WHERE user_type = 'customer'";
